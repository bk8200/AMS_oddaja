...
```
roslaunch amswmr global.launch
roslaunch amswmr global.launch
```
...
```
rosrun amswmr laser_sim _laser_frame_id:="laser1" _robot_frame_ids:="base0 base2 base3 base4 base5" _fov:=180 _ray_count:=180
```

Open visualization in RViz.
```
roslaunch amswmr world.launch
```
...
#include "amswmr/PlanarState.h"
#include "amswmr/LaserSim.h"
